 ...
 */
@Component({
  selector: 'app-criar-grupo-modal',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
          ...
          <form (ngSubmit)="onSubmit()" #grupoForm="ngForm">
            <div class="form-group">
              ...
              <input
                ...
                [disabled]="loading()"
                class="form-control"
                placeholder="Ex: Grupo de Corrida, Clube do Livro...">
            ...
            <div class="form-group">
              ...
              <small class="form-hint">Opcional. Máximo de 500 caracteres</small>
            </div>
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                [disabled]="loading() || !grupoForm.valid">
                <app-loading-spinner 
                  *ngIf="loading()" 
                  size="small">
                </app-loading-spinner>
                <span *ngIf="!loading()">Criar Grupo</span>
...
export class CriarGrupoModalComponent {
  private grupoService = inject(GrupoService);
  private authService = inject(AuthService);

  // Evento emitido quando o grupo é criado com sucesso
  grupoCriado = output<void>();
  ...
  async onSubmit() {
    ...
    if (!currentUser?.id_condominio) {
      this.error.set('Você precisa estar associado a um condomínio para criar grupos.');
      return;
    }
    ...
    const response = await this.grupoService.create(grupoData);

    if (response.error) {
      this.error.set(response.error.message || 'Erro ao criar grupo');
